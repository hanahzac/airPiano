...
{
	{
		...
		L_0 = ((  KeyCollection_tE3C8732C8299AD0E5FFC7B5B3C9E215332601EE1* (*) (Dictionary_2_t02712D85A437174C466DE8AAC0A7E57F4A02FDDA*, const RuntimeMethod*))il2cpp_codegen_get_method_pointer(il2cpp_rgctx_method(method->klass->rgctx_data, 48)))(__this, il2cpp_rgctx_method(method->klass->rgctx_data, 48));
		return (RuntimeObject*)L_0;
	}
}
